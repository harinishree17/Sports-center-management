...
{
	$result = mysqli_query($connect,"SELECT users_email, users_pass FROM users");
	if ($result->num_rows > 0) 
{
	echo "<br><hr><br><table>
<caption>People who have logged in:</caption>
	<tr>
	<th>Email</th>
	<th>Password</th>
	</tr>";
...
{
    echo "<tr><td> " . $row["users_email"]. " </td><td> " . $row["users_pass"]. "</td></tr><br>";
  }
} 
else 
{
