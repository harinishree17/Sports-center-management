...
{
	$result = mysqli_query($connect,"SELECT sign_email, sign_pass, sign_add, sign_phno, sign_game FROM sign");
	if ($result->num_rows > 0) 
{
	echo "<br><hr><br><table>
     <caption>People who have signed in: </caption>
	<tr>
	<th>Email</th>
	<th>Password</th>
	<th>Address</th>
...
{
    echo "<tr><td> " . $row["sign_email"]. " </td><td> " . $row["sign_pass"]. " </td><td> " . $row["sign_add"]. " </td><td> " . $row["sign_phno"]. " </td><td> " . $row["sign_game"]. "</td></tr>";
  }
} 
else 
{
